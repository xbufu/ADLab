Function Set-SMB {
    ...
    <#
        .SYNOPSIS
            Enables file & priter sharing over SMB.

        .DESCRIPTION
            The function creates and configures a new GPO to enable file & printer sharing over SMB. Also creates the appropriate firewall rules.
        ...
        .EXAMPLE
            ...
            Enable SMB and display verbose output. Use default GPO name "Enable SMB"

        .EXAMPLE
            PS > Set-SMB -GPOName "SMB" -Verbose

            Enable SMB with custom GPO name.
    #>
